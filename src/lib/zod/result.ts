...
// Create a function that returns a dynamic assignment mark schema
const createAssignMarkSchema = (maxValue: number) =>
  z
    .union([
      z
        .string()
...
// Create a function that returns a dynamic grade schema
